...
import spdlog;
import spdlog.cfg.env;
import spdlog.sinks.stdout_color_sinks;
import spdlog.sinks.stdout_sinks;
import spdlog.sinks.basic_file_sink;
import spdlog.sinks.rotating_file_sink;
import spdlog.sinks.daily_file_sink;
import spdlog.sinks.callback_sink;
//import spdlog.async;
import spdlog.fmt.bin_to_hex;
import std;
